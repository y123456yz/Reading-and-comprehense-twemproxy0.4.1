...
static struct command conf_commands[] = {
    ...
    { string("preconnect"), //是否twemproxy一起来就和后端服务器建立连接，还是等有数据到来后选举到后端服务器后才建立连接
      conf_set_bool,
...
/*
[2016-07-02 16:56:46.755] nc_conf.c:335 [worker:0] omega
[2016-07-02 16:56:46.755] nc_conf.c:337 [worker:0]   listen: /tmp/gamma
[2016-07-02 16:56:46.755] nc_conf.c:338 [worker:0]   timeout: -1
[2016-07-02 16:56:46.755] nc_conf.c:339 [worker:0]   backlog: 512
[2016-07-02 16:56:46.755] nc_conf.c:340 [worker:0]   hash: 9
[2016-07-02 16:56:46.755] nc_conf.c:342 [worker:0]   hash_tag: ""
[2016-07-02 16:56:46.755] nc_conf.c:343 [worker:0]   distribution: 0
[2016-07-02 16:56:46.755] nc_conf.c:345 [worker:0]   client_connections: 0
[2016-07-02 16:56:46.755] nc_conf.c:346 [worker:0]   redis: 0
[2016-07-02 16:56:46.755] nc_conf.c:347 [worker:0]   preconnect: 0
[2016-07-02 16:56:46.755] nc_conf.c:348 [worker:0]   auto_eject_hosts: 0
[2016-07-02 16:56:46.755] nc_conf.c:350 [worker:0]   server_connections: 1
[2016-07-02 16:56:46.755] nc_conf.c:352 [worker:0]   server_retry_timeout: 30000
[2016-07-02 16:56:46.755] nc_conf.c:354 [worker:0]   server_failure_limit: 2
[2016-07-02 16:56:46.755] nc_conf.c:357 [worker:0]   servers: 2
[2016-07-02 16:56:46.755] nc_conf.c:361 [worker:0]     127.0.0.1:11214:100000
[2016-07-02 16:56:46.755] nc_conf.c:361 [worker:0]     127.0.0.1:11215:1
*/
static void
...
//解析配置项，参考conf_commands  //解析配置项在conf_handler  ,最终存入到conf_pool，参考命令conf_commands
static rstatus_t
conf_handler(struct conf *cf, void *data)
{
    ...
    log_debug(LOG_VVERB, "conf handler on %.*s: %.*s", key->len, key->data, value->len, value->data);
...
conf_post_validate(struct conf *cf)
{
    ...
    for (i = 0; i < npool; i++) { //
        ...
        status = conf_validate_pool(cf, cp); //判断各个server中的相关配置是否有没有配置，如果没有配置则初始化默认值，并判断server间是否重复
        if (status != NC_OK) {
            return status;
        }
    }
    ...
    for (valid = true, i = 0; i < npool - 1; i++) { //判断多个server之间是否有重复的IP
