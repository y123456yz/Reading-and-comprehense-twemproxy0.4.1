...
static int show_help; //-h参数
static int show_version; //-V参数
static int test_conf; //-t参数
static int daemonize; //-d参数  daem
static int describe_stats; //-D参数设置
...
static void
nc_print_run(struct instance *nci) //uname -a
{
    int status;
    struct utsname name;
...
{
    rstatus_t status;
    struct instance nci; //这是所有配置信息、资源信息等的源头
