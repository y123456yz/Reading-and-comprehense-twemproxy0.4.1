...
struct logger { //赋值参考log_init
    char *name;  /* log file name */ //日志文件名
    //level来源在instance->log_level
    int  level;  /* log level */  //真正控制是否输出日志的地方在log_loggable  
    int  fd;     /* log file descriptor */ //日志文件fd
    int  nerror; /* # log error */ //nc_write写日志出错次数
};
